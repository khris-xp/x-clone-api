...
userRouter.post('/follow/:id', auth_middleware_1.default, user_controller_1.default.updateFollowings);
userRouter.post('/unfollow/:id', auth_middleware_1.default, user_controller_1.default.updateUnFollowings);
